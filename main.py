...
from utils import get_vector_db, generate_summary, generate_creative_reports, to_excel
...
if uploaded_file and st.session_state.get("uploaded_filename") != uploaded_file.name:
    # 기존 세션의 캐시된 리소스를 정리하기 위해 주요 키를 삭제
    keys_to_clear = ['vector_db', 'ocr_text', 'summary', 'ksf', 'presentation_outline', 'stage', 'uploaded_filename']
